...
export default function SettingsPage() {
  ...
  const [name, setName] = useState('Michael Richardson');
  const [email, setEmail] = useState('michael@northstar.example');
  const [company, setCompany] = useState('Northstar Commerce Ltd.');
              ...
              <section aria-labelledby="profile-settings-heading">
                ...
                <Card className="settings-card">
                  <div className="profile-identity">
                    <span className="profile-identity__avatar">MR</span>
                    <div><h3>{name}</h3><p>Finance Manager · Enterprise workspace</p></div>
                  ...
                  <div className="settings-card__footer"><Button onClick={() => save()}>Save profile</Button></div>
                </Card>
              </section>
            )}
            ...
            {tab === 'Security' && (
              <section aria-labelledby="security-settings-heading">
                ...
                <div className="settings-card-stack">
                  <Card className="security-control"><span className="security-control__icon">✓</span><div><h3>Multi-factor authentication</h3><p>TOTP authentication is enabled for Michael Richardson.</p></div><Button variant="ghost" onClick={() => save('MFA management opened in demo mode.')}>Manage</Button></Card>
